    ...
    <div>
      ...
      <section className="analytics-card analytics-large-card">
        <div className="analytics-card-header">
          <div>
            ...
            <p>
              Comparison generated from the SmartTrafficAI SUMO simulation
              experiments.
            </p>
          </div>
        </div>
      ...
      <section className="analytics-card ai-insight-card">
        ...
        <div>
          ...
          <p>
            ...
            vehicle demand and provide traffic intelligence to the adaptive
            signal controller. Historical Pune traffic observations are
            transformed into interval-based traffic features before model
            evaluation.
          </p>
      ...
      <section className="analytics-card experiment-card">
        ...
        <p className="experiment-note">
          Results shown above are obtained from the SmartTrafficAI SUMO
          simulation environment and should not be interpreted as real-world
          traffic deployment results.
        </p>
      </section>
    </div>
  );
